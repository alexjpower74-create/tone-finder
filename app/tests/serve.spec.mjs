...
test.describe('serve.mjs', () => {
  ...
  const missing = [
    '/tests/', '/tests/ask.spec.mjs', '/tools/', '/tools/build-mock.mjs', '/mock/', '/mock', '/serve.mjs',
    '/playwright.config.mjs', '/../package.json', '/%2e%2e/package.json', '/..%2fAGENTS.md', '/.rig/BRIEF.md',
    '/.tf-dotfile-probe.txt', '/nope.html',
  ];
